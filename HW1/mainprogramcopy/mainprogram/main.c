...
//most code descriptions are located in function files. (hashtable.c and getwordPairs.c)
...
//usually range from 1 to MAX_INT <typically 2147483647>. values over 250 million being
